...
import 'package:multi_window_manager/src/widgets/drag_to_move_area.dart';
import 'package:multi_window_manager/src/widgets/window_caption_button.dart';
      ...
      child: Row(
        children: [
          ...
          ValueListenableBuilder(
            valueListenable: MultiWindowManager.current.isClosableNotif,
            builder: (context, isClosable, _) {
              if (!isClosable) return const SizedBox();
              return Row(
                ...
                children: [
                  ...
                  ValueListenableBuilder(
                      valueListenable:
                          MultiWindowManager.current.isResizableNotif,
                      builder: (context, isResizable, _) {
                        if (!isResizable) return const SizedBox();
                        return FutureBuilder<bool>(
                          future: MultiWindowManager.current.isMaximized(),
